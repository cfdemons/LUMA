...
public:
	...
	///         It uses the L_U_phys introduced by the user, dx and dt. 
	///			You can introduce any L_U_phys you want, but the reference lenght (usualy the width of the domain)
	///         , the Re number and the LBM parameters will remain the same. So you will be implicitly changing the physical viscosity
	///         of your fluid when you change L_U_phys 
	///
	...
	{
		return (ulat*currentGrid->dx*L_U_phys) / currentGrid->dt;
	}
