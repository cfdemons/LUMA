...
#define L_PARABOLIC_INLET		///< Use analytic expression for inlet profile - (requires L_REGULARISED_BOUNDARIES)
...
{
	{ 0.05 + L_WALL_THICKNESS_BOTTOM }
};
static double cRefEndY[L_NUM_LEVELS][L_NUM_REGIONS] = 
{
	{ 0.36 + L_WALL_THICKNESS_BOTTOM }
};
