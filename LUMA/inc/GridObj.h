...
public :
	...
	// LBM operations
	void LBM_multi(bool ibmFlag);		// Launch the multi-grid kernel
	...
	void io_fgaout();							// Writes out the macroscopic velocity components for the class as well as any subgrids to a different .fga file for each subgrid. .fga format is the one used for Unreal Engine 4 VectorField object.  
