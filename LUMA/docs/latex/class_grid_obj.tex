...
\begin{DoxyCompactList}\small\item\em \begin{quote}
Non-\/\+M\+PI wrapper for initialiser \end{quote}
\end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Method to compute or reset body forces. \end{DoxyCompactList}\item 
...
Useful grid quantities written out as scalar arrays. One $\ast$.h5 file per grid and data is grouped into timesteps within each file.
...
Takes Cartesian force vector and populates forces for each lattice direction. If reset\+\_\+flag is true, then resets the force vectors to zero.


\begin{DoxyParams}{Parameters}
{\em reset\+\_\+flag} & flag to indicate whether force vectors should simply be reset. \\
\hline
\end{DoxyParams}
...
Method to initialise the lattice density. \index{Grid\+Obj@{Grid\+Obj}!L\+B\+M\+\_\+init\+Solid\+Lab@{L\+B\+M\+\_\+init\+Solid\+Lab}}
...
\begin{DoxyParams}{Parameters}
{\em I\+B\+M\+\_\+flag} & flag to indicate whether this kernel is a predictor (true) or corrector (false) step when using I\+BM. \\
\hline
\end{DoxyParams}
