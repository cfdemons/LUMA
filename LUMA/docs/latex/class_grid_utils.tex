...
static void \hyperlink{class_grid_utils_a8af73cff3f009b0cc27c71af4dae0780}{get\+Grid} (\hyperlink{class_grid_obj}{Grid\+Obj} $\ast$const Grids, int level, int region, \hyperlink{class_grid_obj}{Grid\+Obj} $\ast$\&ptr)
\begin{DoxyCompactList}\small\item\em Get a pointer to a given grid in the hierarchy. \end{DoxyCompactList}\item 
static bool \hyperlink{class_grid_utils_ac523515920794475c3577923562716bd}{is\+Overlap\+Periodic} (int i, int j, int k, \hyperlink{class_grid_obj}{Grid\+Obj} const \&p\+Grid)
...
static bool \hyperlink{class_grid_utils_ae21da9e811f7ea944a996eaa5d203da2}{is\+On\+This\+Rank} (double x, double y, double z, \hyperlink{_enumerations_8h_a478f1e2cf9934de79a892e60980598dc}{e\+Location\+On\+Rank} $\ast$loc=nullptr, \hyperlink{class_grid_obj}{Grid\+Obj} const $\ast$const grid=nullptr, std\+::vector$<$ int $>$ $\ast$pos=nullptr)
...
static bool \hyperlink{class_grid_utils_a70ec04909851ae9c573e1d439f5c455d}{is\+On\+This\+Rank} (double xyz, \hyperlink{_enumerations_8h_afbad8e4a2f1e9903755b1bd2fe8273cf}{e\+Cartesian\+Direction} dir, \hyperlink{_enumerations_8h_a478f1e2cf9934de79a892e60980598dc}{e\+Location\+On\+Rank} $\ast$loc=nullptr, \hyperlink{class_grid_obj}{Grid\+Obj} const $\ast$const grid=nullptr, int $\ast$pos=nullptr)
...
static bool \hyperlink{class_grid_utils_af1e1194072f958e70ad453b521008766}{intersects\+Refined\+Region} (\hyperlink{class_grid_obj}{Grid\+Obj} const \&p\+Grid, int Reg\+Num)
...
static bool \hyperlink{class_grid_utils_a9179e27b25b1be249edd6d22455d57bd}{is\+On\+Sender\+Layer} (double site\+\_\+position, \hyperlink{_enumerations_8h_a0cc91691e907a6a03b129d18a62fe33d}{e\+Cart\+Min\+Max} edge)
\begin{DoxyCompactList}\small\item\em Check whether site is on an inner (sender) halo. \end{DoxyCompactList}\item 
static bool \hyperlink{class_grid_utils_a381a3ef0d42132313081b5c06f732092}{is\+On\+Recv\+Layer} (double site\+\_\+position, \hyperlink{_enumerations_8h_a0cc91691e907a6a03b129d18a62fe33d}{e\+Cart\+Min\+Max} edge)
\begin{DoxyCompactList}\small\item\em Check whether site is on an outer (receiver) halo. \end{DoxyCompactList}\item 
...
static int \hyperlink{class_grid_utils_a4fa92a1d400687f75e1fce1c8eb406e6}{safe\+Get\+Rank} ()
\begin{DoxyCompactList}\small\item\em Safe method to get the rank number. \end{DoxyCompactList}\item 
static bool \hyperlink{class_grid_utils_a220d6b870c7b422a087324ad860d96f8}{is\+Off\+Grid} (int i, int j, int k, \hyperlink{class_grid_obj}{Grid\+Obj} const $\ast$const g)
\begin{DoxyCompactList}\small\item\em Tests whether a site is on a given grid. \end{DoxyCompactList}\item 
static void \hyperlink{class_grid_utils_a4eaf386de2bdd96502c595e73302c029}{get\+Enclosing\+Voxel} (double x, double y, double z, \hyperlink{class_grid_obj}{Grid\+Obj} const $\ast$const g, std\+::vector$<$ int $>$ $\ast$ijk)
...
static void \hyperlink{class_grid_utils_a02c27032afa91f879536237b0373e014}{get\+Enclosing\+Voxel} (double x, \hyperlink{class_grid_obj}{Grid\+Obj} const $\ast$const g, \hyperlink{_enumerations_8h_afbad8e4a2f1e9903755b1bd2fe8273cf}{e\+Cartesian\+Direction} dir, int $\ast$ijk)
\begin{DoxyCompactList}\small\item\em Get local voxel indices on grid in which provided position lies. \end{DoxyCompactList}\item 
static bool \hyperlink{class_grid_utils_aa1f693d4b4438c83f994b83c54b11b6c}{is\+On\+Transition\+Layer} (double pos\+\_\+x, double pos\+\_\+y, double pos\+\_\+z, \hyperlink{class_grid_obj}{Grid\+Obj} const $\ast$const grid)
\begin{DoxyCompactList}\small\item\em Check whether site is on a TL. \end{DoxyCompactList}\item 
static bool \hyperlink{class_grid_utils_ae05559ab787c9eccedde24be270a51c9}{is\+On\+Transition\+Layer} (double position, \hyperlink{_enumerations_8h_a0cc91691e907a6a03b129d18a62fe33d}{e\+Cart\+Min\+Max} edge, \hyperlink{class_grid_obj}{Grid\+Obj} const $\ast$const grid)
...
\subsubsection[{\texorpdfstring{get\+Enclosing\+Voxel(double x, double y, double z, Grid\+Obj const $\ast$const g, std\+::vector$<$ int $>$ $\ast$ijk)}{getEnclosingVoxel(double x, double y, double z, GridObj const *const g, std::vector< int > *ijk)}}]{\setlength{\rightskip}{0pt plus 5cm}void Grid\+Utils\+::get\+Enclosing\+Voxel (
\begin{DoxyParamCaption}
\item[{double}]{x, }
\item[{double}]{y, }
\item[{double}]{z, }
\item[{{\bf Grid\+Obj} const $\ast$const}]{g, }
\item[{std\+::vector$<$ int $>$ $\ast$}]{ijk}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}\hypertarget{class_grid_utils_a4eaf386de2bdd96502c595e73302c029}{}\label{class_grid_utils_a4eaf386de2bdd96502c595e73302c029}
...
\index{Grid\+Utils@{Grid\+Utils}!get\+Enclosing\+Voxel@{get\+Enclosing\+Voxel}}
\index{get\+Enclosing\+Voxel@{get\+Enclosing\+Voxel}!Grid\+Utils@{Grid\+Utils}}
\subsubsection[{\texorpdfstring{get\+Enclosing\+Voxel(double x, Grid\+Obj const $\ast$const g, e\+Cartesian\+Direction dir, int $\ast$ijk)}{getEnclosingVoxel(double x, GridObj const *const g, eCartesianDirection dir, int *ijk)}}]{\setlength{\rightskip}{0pt plus 5cm}void Grid\+Utils\+::get\+Enclosing\+Voxel (
\begin{DoxyParamCaption}
\item[{double}]{xyz, }
\item[{{\bf Grid\+Obj} const $\ast$const}]{g, }
...
\item[{int $\ast$}]{ijk}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}\hypertarget{class_grid_utils_a02c27032afa91f879536237b0373e014}{}\label{class_grid_utils_a02c27032afa91f879536237b0373e014}
...
\subsubsection[{\texorpdfstring{get\+Grid(\+Grid\+Obj $\ast$const Grids, int level, int region, Grid\+Obj $\ast$\&ptr)}{getGrid(GridObj *const Grids, int level, int region, GridObj *&ptr)}}]{\setlength{\rightskip}{0pt plus 5cm}void Grid\+Utils\+::get\+Grid (
\begin{DoxyParamCaption}
\item[{{\bf Grid\+Obj} $\ast$const}]{Grids, }
\item[{int}]{level, }
\item[{int}]{region, }
\item[{{\bf Grid\+Obj} $\ast$\&}]{ptr}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}\hypertarget{class_grid_utils_a8af73cff3f009b0cc27c71af4dae0780}{}\label{class_grid_utils_a8af73cff3f009b0cc27c71af4dae0780}
...
\begin{DoxyParams}[1]{Parameters}
 & {\em Grids} & constant pointer to the grid at which to start searching. \\
\hline
 & {\em level} & level desired. \\
\hline
 & {\em region} & region desried. \\
\hline
\mbox{\tt out}  & {\em ptr} & reference to pointer where address of grid matching in hierarchy will be assigned. \\
\hline
\end{DoxyParams}
...
\subsubsection[{\texorpdfstring{intersects\+Refined\+Region(\+Grid\+Obj const \&p\+Grid, int Reg\+Num)}{intersectsRefinedRegion(GridObj const &pGrid, int RegNum)}}]{\setlength{\rightskip}{0pt plus 5cm}bool Grid\+Utils\+::intersects\+Refined\+Region (
\begin{DoxyParamCaption}
\item[{{\bf Grid\+Obj} const \&}]{p\+Grid, }
\item[{int}]{Reg\+Num}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}\hypertarget{class_grid_utils_af1e1194072f958e70ad453b521008766}{}\label{class_grid_utils_af1e1194072f958e70ad453b521008766}
...
\subsubsection[{\texorpdfstring{is\+Off\+Grid(int i, int j, int k, Grid\+Obj const $\ast$const g)}{isOffGrid(int i, int j, int k, GridObj const *const g)}}]{\setlength{\rightskip}{0pt plus 5cm}bool Grid\+Utils\+::is\+Off\+Grid (
\begin{DoxyParamCaption}
\item[{int}]{i, }
\item[{int}]{j, }
\item[{int}]{k, }
\item[{{\bf Grid\+Obj} const $\ast$const}]{g}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}\hypertarget{class_grid_utils_a220d6b870c7b422a087324ad860d96f8}{}\label{class_grid_utils_a220d6b870c7b422a087324ad860d96f8}
...
\subsubsection[{\texorpdfstring{is\+On\+This\+Rank(double x, double y, double z, e\+Location\+On\+Rank $\ast$loc=nullptr, Grid\+Obj const $\ast$const grid=nullptr, std\+::vector$<$ int $>$ $\ast$pos=nullptr)}{isOnThisRank(double x, double y, double z, eLocationOnRank *loc=nullptr, GridObj const *const grid=nullptr, std::vector< int > *pos=nullptr)}}]{\setlength{\rightskip}{0pt plus 5cm}bool Grid\+Utils\+::is\+On\+This\+Rank (
\begin{DoxyParamCaption}
\item[{double}]{x, }
\item[{double}]{y, }
\item[{double}]{z, }
\item[{{\bf e\+Location\+On\+Rank} $\ast$}]{loc = {\ttfamily nullptr}, }
\item[{{\bf Grid\+Obj} const $\ast$const}]{grid = {\ttfamily nullptr}, }
\item[{std\+::vector$<$ int $>$ $\ast$}]{pos = {\ttfamily nullptr}}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}\hypertarget{class_grid_utils_ae21da9e811f7ea944a996eaa5d203da2}{}\label{class_grid_utils_ae21da9e811f7ea944a996eaa5d203da2}
...
\index{Grid\+Utils@{Grid\+Utils}!is\+On\+This\+Rank@{is\+On\+This\+Rank}}
\index{is\+On\+This\+Rank@{is\+On\+This\+Rank}!Grid\+Utils@{Grid\+Utils}}
\subsubsection[{\texorpdfstring{is\+On\+This\+Rank(double xyz, e\+Cartesian\+Direction dir, e\+Location\+On\+Rank $\ast$loc=nullptr, Grid\+Obj const $\ast$const grid=nullptr, int $\ast$pos=nullptr)}{isOnThisRank(double xyz, eCartesianDirection dir, eLocationOnRank *loc=nullptr, GridObj const *const grid=nullptr, int *pos=nullptr)}}]{\setlength{\rightskip}{0pt plus 5cm}bool Grid\+Utils\+::is\+On\+This\+Rank (
\begin{DoxyParamCaption}
\item[{double}]{xyz, }
\item[{{\bf e\+Cartesian\+Direction}}]{dir, }
\item[{{\bf e\+Location\+On\+Rank} $\ast$}]{loc = {\ttfamily nullptr}, }
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}\hypertarget{class_grid_utils_a70ec04909851ae9c573e1d439f5c455d}{}\label{class_grid_utils_a70ec04909851ae9c573e1d439f5c455d}
...
\subsubsection[{\texorpdfstring{is\+On\+Transition\+Layer(double pos\+\_\+x, double pos\+\_\+y, double pos\+\_\+z, Grid\+Obj const $\ast$const grid)}{isOnTransitionLayer(double pos_x, double pos_y, double pos_z, GridObj const *const grid)}}]{\setlength{\rightskip}{0pt plus 5cm}bool Grid\+Utils\+::is\+On\+Transition\+Layer (
\begin{DoxyParamCaption}
\item[{double}]{pos\+\_\+x, }
\item[{double}]{pos\+\_\+y, }
\item[{double}]{pos\+\_\+z, }
\item[{{\bf Grid\+Obj} const $\ast$const}]{grid}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}\hypertarget{class_grid_utils_aa1f693d4b4438c83f994b83c54b11b6c}{}\label{class_grid_utils_aa1f693d4b4438c83f994b83c54b11b6c}
...
\index{Grid\+Utils@{Grid\+Utils}!is\+On\+Transition\+Layer@{is\+On\+Transition\+Layer}}
\index{is\+On\+Transition\+Layer@{is\+On\+Transition\+Layer}!Grid\+Utils@{Grid\+Utils}}
\subsubsection[{\texorpdfstring{is\+On\+Transition\+Layer(double position, e\+Cart\+Min\+Max edge, Grid\+Obj const $\ast$const grid)}{isOnTransitionLayer(double position, eCartMinMax edge, GridObj const *const grid)}}]{\setlength{\rightskip}{0pt plus 5cm}bool Grid\+Utils\+::is\+On\+Transition\+Layer (
\begin{DoxyParamCaption}
\item[{double}]{position, }
\item[{{\bf e\+Cart\+Min\+Max}}]{edge, }
\item[{{\bf Grid\+Obj} const $\ast$const}]{grid}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}\hypertarget{class_grid_utils_ae05559ab787c9eccedde24be270a51c9}{}\label{class_grid_utils_ae05559ab787c9eccedde24be270a51c9}
...
\subsubsection[{\texorpdfstring{is\+Overlap\+Periodic(int i, int j, int k, Grid\+Obj const \&p\+Grid)}{isOverlapPeriodic(int i, int j, int k, GridObj const &pGrid)}}]{\setlength{\rightskip}{0pt plus 5cm}bool Grid\+Utils\+::is\+Overlap\+Periodic (
\begin{DoxyParamCaption}
\item[{int}]{i, }
\item[{int}]{j, }
\item[{int}]{k, }
\item[{{\bf Grid\+Obj} const \&}]{g}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}\hypertarget{class_grid_utils_ac523515920794475c3577923562716bd}{}\label{class_grid_utils_ac523515920794475c3577923562716bd}
...
\end{DoxyReturn}
\index{Grid\+Utils@{Grid\+Utils}!safe\+Get\+Rank@{safe\+Get\+Rank}}
\index{safe\+Get\+Rank@{safe\+Get\+Rank}!Grid\+Utils@{Grid\+Utils}}
\subsubsection[{\texorpdfstring{safe\+Get\+Rank()}{safeGetRank()}}]{\setlength{\rightskip}{0pt plus 5cm}int Grid\+Utils\+::safe\+Get\+Rank (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}\hypertarget{class_grid_utils_a4fa92a1d400687f75e1fce1c8eb406e6}{}\label{class_grid_utils_a4fa92a1d400687f75e1fce1c8eb406e6}


Safe method to get the rank number. 

This is a serial/parallel agnostic method to get the rank number. This is necessary as often we just want to access the rank number for logging purposes and don\textquotesingle{}t want to have to wrap every call to avoid attempts to use the M\+PI manager in non-\/\+M\+PI code.
