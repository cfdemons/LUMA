...
Converts velocity component from lattice units to m/s. It uses the L\+\_\+\+P\+H\+Y\+S\+I\+C\+A\+L\+\_\+U introduced by the user, dh and dt. You can introduce any L\+\_\+\+P\+H\+Y\+S\+I\+C\+A\+L\+\_\+U you want, but the reference lenght (usualy the width of the domain) , the Re number and the L\+BM parameters will remain the same. So you will be implicitly changing the physical viscosity of your fluid when you change L\+\_\+\+P\+H\+Y\+S\+I\+C\+A\+L\+\_\+U
